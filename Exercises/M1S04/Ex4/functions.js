...
class ContaPoupanca extends Conta {
  ...
  juros() {
    ...
    console.log(`Após o ganho com o juros o novo saldo é R$ ${newValue}`);
  }
}

class ContaPoupancaPremium extends ContaPoupanca {
  constructor(saldo, senha, deposito, retirada, juros) {
    super(saldo, senha, deposito, retirada, juros);
  }

  juros() {
    let newValue = (this.saldo * 1.012).toFixed(2);
    console.log(
      `Após o ganho com um juros melhor o novo saldo é R$ ${newValue}`
    );
  }
}

let contaCorrente = new ContaPoupancaPremium(300, 1235);
